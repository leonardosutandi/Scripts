...
for i = 1:length(allGrp)    
    ...
    % Load participant
    [STUDY ALLEEG] = std_editset(STUDY, ALLEEG, 'name', condType ,'commands',{ ...
        {'index',i,'load',['C:\\MATLAB\\exp_1\\results\\EEG\\' grp '\\' allGrp{i} '\\alphaBeh_' condType '_' allGrp{i} '.set']}, ...
...
% Write to csv
filename = ['C:\\MATLAB\\exp_1\\results\\EEG\\STUDY\\within\\alphaBeh\\within_' grp '_' condType '_' chanTitle '.csv'];
...
% Write to csv
filename = ['C:\\MATLAB\\exp_1\\results\\EEG\\STUDY\\between\\alphaBeh\\between_' grp '_' condType '_' chanTitle '.csv'];
